...
//DEFINE DATLICH PATH
  ...
  return async (event) => {
    ...
    let thuebot;
        ...
        if (!find_thuebot)return api.shareContact(`❎ Nhóm của bạn chưa thuê bot, vui lòng liên hệ Admin ${config.AMDIN_NAME} để thuê bot`, global.config.ADMINBOT[0], event.threadID);
